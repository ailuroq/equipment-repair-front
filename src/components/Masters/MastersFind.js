...
import {findMaster} from "../../redux/actions/masters";
...
const MastersFind = () => {
    ...
    return (
        <div className={styles.find_or_add}>
            ...
            <div>
                <Button id={styles.add_button} variant="outlined" color="primary"><a href={'masters/new'}>Добавить</a></Button>
            </div>
        </div>
    )
}

export default MastersFind
